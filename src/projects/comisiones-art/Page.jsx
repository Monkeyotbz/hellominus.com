...
export default function ComisionesArtPage() {
    ...
    <div className="min-h-screen flex flex-col bg-night-950">
      ...
      <div className="border-b border-amber-500/20 bg-amber-500/5">
        <p className="mx-auto max-w-6xl px-5 py-1.5 text-[11px] text-amber-300/90 text-center">
          Todos los nombres, montos, credenciales y correos de esta página son <strong>ficticios</strong> — proyecto
          de portafolio, no representa clientes ni datos reales.
        </p>
      </div>
      ...
      <main className="flex-1">
        <AnimatePresence mode="wait">
          ...
          >
            {view === "caso" ? <CaseStudy onOpenDemo={() => setView("demo")} /> : <DemoApp />}
          </motion.div>
        </AnimatePresence>
      </main>
