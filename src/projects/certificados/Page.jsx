    ...
    <div className="min-h-screen flex flex-col bg-night-950">
      ...
      <div className="border-b border-amber-500/20 bg-amber-500/5">
        <p className="mx-auto max-w-6xl px-5 py-1.5 text-[11px] text-amber-300/90 text-center">
          Todos los datos de esta página (pólizas, clientes, asegurados) son <strong>ficticios</strong> — proyecto de
          portafolio con una interfaz rediseñada, no representa clientes ni certificados reales.
        </p>
      </div>
